...
import { Check, X, Clock, Wallet, Zap } from 'lucide-react';
  ...
  return (
    <section className="py-20 px-4 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        {/* Colonne Marché */}
        <div className="p-8 rounded-[2.5rem] border border-gray-100 bg-gray-50/50 grayscale opacity-70 hover:opacity-100 transition-opacity duration-300">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between border-b border-gray-200 pb-4">
              ...
              <span className="text-xl font-bold text-gray-400 decoration-red-400">1 500€ - 3 000€</span>
            </div>
            ...
            <div className="flex items-center justify-between border-b border-gray-200 pb-4">
              ...
              <span className="text-xl font-bold text-gray-400">3 à 5 Semaines</span>
            </div>
        ...
        <div className="relative p-10 rounded-[2.5rem] border-2 border-[#25D366] bg-white shadow-2xl shadow-green-100 scale-[1.02] transform">
          <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#25D366] text-white px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest shadow-lg">
            Meilleur Choix
          </div>
